...
class _HomePageState extends State<HomePage> {
  ...
  Future getData() async {
    //https://raw.githubusercontent.com/boomnicekab/BasicAPI/main/data.json
    var url = Uri.https(
        'raw.githubusercontent.com', '/boomnicekab/BasicAPI/main/data.json');
